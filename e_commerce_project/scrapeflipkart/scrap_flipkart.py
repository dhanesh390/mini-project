...
class Flipkart():
    ...
    def page_load(self):
        ...
        try:
            login_pop = self.driver.find_element('name', '_29YdH8')
        ...
        search_field = self.driver.find_element('name', 'LM6RPg')
    ...
    def data_scrap(self):
        ...
        for i in first_page_mobiles:
            ...
            price = price.text[1:]
            self.mycsv.writerow(
                {"Name": Name, "Storage_details": storage, "Screen_size": screen_size, "Camera_details": camera_details,
                 "Battery_details": battery_details, "Processor": processor, "Warranty": warranty_details,
